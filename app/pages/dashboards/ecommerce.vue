			...
			<div class="lg:landscape:col-span-3 relative col-span-12 md:col-span-6 2xl:landscape:col-span-3">
				<BaseCard rounded="md" class="p-4">
					<div class="flex items-center justify-between">
						<div>
							<BaseHeading as="h4" size="sm" weight="medium" lead="tight" class="text-muted-600 dark:text-muted-400">
								<span>Sales</span>
							</BaseHeading>
							<BaseText size="xl" weight="semibold" class="text-muted-900 dark:text-muted-100"> 641.4k </BaseText>
						</div>
						<Icon name="solar:cart-large-2-bold-duotone" class="text-primary-500 size-8" />
					</div>
					<div class="pt-4">
						<DemoDemoChartLineSparkOne />
					</div>
				</BaseCard>
			</div>
			<!-- Tile -->
				...
				<BaseCard rounded="md" class="p-4">
					<div class="flex items-center justify-between">
						<div>
							...
							<BaseText size="xl" weight="semibold" class="text-muted-900 dark:text-muted-100"> $389.9k </BaseText>
						</div>
						<Icon name="solar:banknote-bold-duotone" class="text-success-500 size-8" />
					</div>
					<div class="pt-4">
						<DemoDemoChartLineSparkTwo />
					</div>
				</BaseCard>
			</div>
			<!-- Tile -->
				...
				<BaseCard rounded="md" class="p-4">
					<div class="flex items-center justify-between">
						<div>
							...
							<BaseText size="xl" weight="semibold" class="text-muted-900 dark:text-muted-100"> 981 </BaseText>
						</div>
						<Icon name="solar:box-bold-duotone" class="text-info-500 size-8" />
					</div>
					<div class="pt-4">
						<DemoDemoChartLineSparkThree />
					</div>
				</BaseCard>
			</div>
			<!-- Tile -->
				...
				<BaseCard rounded="md" class="p-4">
					<div class="flex items-center justify-between">
						<div>
							...
							<BaseText size="xl" weight="semibold" class="text-muted-900 dark:text-muted-100"> 43 </BaseText>
						</div>
						<Icon name="solar:cart-cross-bold-duotone" class="text-destructive-500 size-8" />
					</div>
					<div class="pt-4">
						<DemoDemoChartLineSparkFour />
					</div>
				</BaseCard>
			</div>
			<!-- Chart -->
			<div class="relative col-span-12 xl:landscape:col-span-6 2xl:landscape:col-span-7">
				<BaseCard rounded="md" class="p-4 md:p-6 flex flex-col h-full">
					<div class="mb-2 flex items-center justify-between">
						...
						<BaseButton size="sm" rounded="md"> Details </BaseButton>
					</div>
					<div class="flex gap-8">
						<div>
							<span class="text-muted-600 dark:text-muted-400 font-sans text-xs">This month</span>
							<p class="text-muted-900 dark:text-muted-100 font-sans text-lg font-medium">$75,689</p>
						</div>
						<div>
							<span class="text-muted-600 dark:text-muted-400 font-sans text-xs">Last month</span>
							<p class="text-muted-900 dark:text-muted-100 font-sans text-lg font-medium">$59,724</p>
						</div>
						<div>
							<span class="text-muted-600 dark:text-muted-400 font-sans text-xs">Average</span>
							<p class="text-muted-900 dark:text-muted-100 font-sans text-lg font-medium">$66,561</p>
						</div>
					</div>
					<div class="mt-auto">
				...
				<div class="flex h-full flex-col gap-4">
					...
					<BaseCard class="flex-1 p-6">
						<div class="flex items-center justify-center">
							<div class="flex-1">
								<BaseHeading as="h3" size="md" weight="medium" lead="tight" class="text-muted-900 mb-4 dark:text-white">
									<span>Sales Revenue</span>
								</BaseHeading>
								<BaseHeading as="h4" size="lg" weight="medium" lead="tight" class="text-muted-900 mb-2 dark:text-white">
									<span>$8,641.26</span>
								</BaseHeading>
								<BaseParagraph size="xs">
									<span class="text-muted-600 dark:text-muted-400"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Bonum integritas corporis. </span>
								</BaseParagraph>
							</div>
							<div class="flex-1">
								<DemoDemoChartRadialSalesRevenue />
							</div>
						</div>
					</BaseCard>
					<!-- Charts -->
					<BaseCard rounded="md" class="flex-1 p-6">
						...
						<div class="flex justify-between">
							<div class="flex flex-col gap-2 text-center w-1/3">
								<DemoDemoChartRadialSmallOne />

								<div class="-mt-6">
									<BaseHeading as="h5" size="md" weight="semibold" lead="tight" class="text-muted-800 dark:text-white">
										<span>278</span>
									</BaseHeading>
									<BaseParagraph size="xs">
