...
<template>
	<div>
		...
		<CheckboxGroupRoot v-model="project.tools" as="div" class="mx-auto grid max-w-4xl gap-4 px-4 sm:grid-cols-3">
			<!-- Tools -->
			<CheckboxRoot v-for="tool in tools" :key="tool.name" :value="tool">
				<CheckboxIndicator force-mount class="group">
					<BaseCard rounded="lg" class="group-data-[state=checked]:border-primary-500 group-data-[state=checked]:shadow-muted-300/30 dark:group-data-[state=checked]:shadow-muted-900/30 p-4 group-data-[state=checked]:shadow-xl">
