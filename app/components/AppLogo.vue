<template>
	<div :class="wrapperClass">
		<img :src="logoSrc" :alt="alt" class="object-contain logo-responsive" :style="inlineStyle" loading="lazy" decoding="async" />
	</div>
</template>
...
<script setup lang="ts">
	...
	const logoSrc = computed(() => (colorMode.value === 'dark' ? '/img/logo-dark.png' : '/img/logo-light.png'))
	...
	const mobileWidthValue = computed(() => {
		...
		return typeof props.mobileWidth === 'number' ? `${props.mobileWidth}px` : props.mobileWidth
	})
</script>
