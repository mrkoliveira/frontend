...
<template>
	<div
		...
		:class="[props.centered ? 'mx-auto' : '', props.contrast === 'high' && 'dark:bg-muted-950', props.contrast === 'low' && 'dark:bg-muted-900']"
	>
		<!-- Card content -->
		<div class="flex h-full flex-col gap-3">
			...
			<div class="mt-auto space-y-1">
				<img class="mb-3 w-11" src="/img/illustrations/card-chip.svg" alt="Card chip" width="44" height="31" />
				<div>
				...
				<div class="font-heading text-muted-400 flex w-full items-center gap-2 text-xs">
					<div class="flex items-center gap-2">
						<span>EXP</span>
		...
		<div class="absolute end-5 top-4 flex">
			...
			<div class="relative z-10 -ms-2 size-9 rounded-full bg-yellow-500/60" />
		</div>

		<!-- Logo -->
		<div class="absolute bottom-7 end-5 flex">
			<AppLogo class="text-primary-500 size-10" />
		</div>
	</div>
</template>
