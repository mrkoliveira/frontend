...
<template>
	<FocusScope class="border-muted-200 dark:border-muted-700 dark:bg-muted-800 border-l bg-white" trapped loop>
		<div class="border-muted-200 dark:border-muted-700 flex h-20 w-full items-center justify-between border-b px-6">
			<BaseHeading as="h3" size="xs" weight="semibold" class="text-muted-500 dark:text-muted-100 uppercase"> Account Details </BaseHeading>
		...
		<div class="nui-slimscroll relative h-[calc(100dvh_-_5rem)] w-full overflow-y-auto overflow-x-hidden p-6">
			...
			<div class="flex items-center justify-between">
				<div>
					<BaseHeading as="h4" size="lg" weight="medium" class="text-muted-900 dark:text-muted-100 capitalize"> {{ props.account.type }} {{ props.account.number }} </BaseHeading>
				...
				<div class="py-6 pe-4 text-end">
					<BaseParagraph size="xs" class="text-muted-600 dark:text-muted-400 mb-1"> Account balance </BaseParagraph>
					<BaseParagraph size="2xl" weight="medium" class="text-muted-900 dark:text-muted-100 mb-1">
			...
			<div class="space-y-4 py-6 pe-4">
				...
				<div class="flex items-center justify-between">
					<div class="flex items-center gap-2">
						...
						<BaseParagraph size="sm" class="text-muted-700 dark:text-muted-400"> Routing number </BaseParagraph>
				...
				<div class="flex items-center justify-between">
					<div class="flex items-center gap-2">
						<div class="bg-muted-500 size-2 rounded-full" />
						<BaseParagraph size="sm" class="text-muted-700 dark:text-muted-400"> Account number </BaseParagraph>
				...
				<div class="flex items-center justify-between">
					<div class="flex items-center gap-2">
						...
						<BaseParagraph size="sm" class="text-muted-700 dark:text-muted-400"> IBAN </BaseParagraph>
				...
				<div class="flex items-center justify-between">
					<div class="flex items-center gap-2">
						...
						<BaseParagraph size="sm" class="text-muted-700 dark:text-muted-400"> Bank code </BaseParagraph>
					</div>
					<BaseText size="sm" weight="medium" class="text-muted-800 dark:text-muted-100">
