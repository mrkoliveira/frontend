				...
				<div>
					<ul class="font-sans text-lg space-y-2">
						<li v-for="item in menu" :key="item.link">
							<NuxtLink :to="item.link" class="text-muted-600 dark:text-muted-400 underline-offset-8" exact-active-class="underline font-medium text-muted-900! dark:text-white!">
								{{ item.title }}
							</NuxtLink>
						</li>
					</ul>
